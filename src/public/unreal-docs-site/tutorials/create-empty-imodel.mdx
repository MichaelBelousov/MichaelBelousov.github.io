...
- Project created and configured. Instructions on how to create a project can be found [here](/tutorials/create-and-query-projects-guide).

</TutorialSection>

<TutorialSection actions={[<CreateSampleAppButton scopes={['realitydata:read','imodels:read','imodels:modify','library:read','storage:read','storage:modify']} clientName="Create empty iModel tutorial"/>]}>
...
**projectId** - provides Project identifier that created iModel will belong to. Project identifier is required property. <br />
...
You can execute the request in [Create iModel documentation](/apis/imodels/operations/create-imodel/) page, "Try it" section.
