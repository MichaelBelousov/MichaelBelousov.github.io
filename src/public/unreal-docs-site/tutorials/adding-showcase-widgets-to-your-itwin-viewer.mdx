...
<Introduction 
  skillLevel="Basic" 
  durationInMinutes="30" 
  summaryImageSrc="/unreal-docs-site/images/adding-showcase-widgets-to-your-itwin-viewer-sample.gif">
...
- Your own [local source](https://github.com/iTwin/viewer) for the iTwin Web Viewer based on the template @itwin/web-viewer
...
- Understand the concept of a [UI Provider](https://www.itwinjs.org/learning/ui/abstract/uiitemsprovider) and adding [widgets](https://www.itwinjs.org/reference/ui-abstract/uiitemsprovider/uiitemsprovider/).
- Completed ["Customizing the iTwin Viewer"](/tutorials/itwin-viewer-hello-world) tutorial.
...
<TutorialSection actions={[
  <Title>The Viewer component in ViewAttributesApp.tsx file</Title>,
<CodeBlock language='jsx' code={`<Viewer
...
<TutorialSection hasTitle={false} actions={[
  <Title>Passing ViewAttributesWidgetProvider to uiProviders</Title>,
<CodeBlock language='jsx' code={`import { ViewAttributesWidgetProvider } from "./ViewAttributesWidget";
...
...
<CodeBlock language='jsx' code={`... // Import the widget provider
...
<TileList>
  <Tile
    ...
    thumbnail="/unreal-docs-site/images/retail-tutorial-sample-small.png"
