...
<Introduction skillLevel="Basic" durationInMinutes={metadata.tile.durationInMinutes}>
...
<TutorialSection subSection={true} actions={[
  <Title>Create Your Account form</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/create-account-form.png"
     alt="Create Your Account"
     className="sample-img-m"
   />,
  <Title>Email Address verification</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/verify-email-address.png"
...
<TutorialSection subSection={true} actions={[
  <Title>Sign in page</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/sign-in-page.png"
     alt="Sign in"
     className="sample-img-m"
   />
]}>
...
<TutorialSection actions={[
  <Title>Application registration form</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/register-your-application-form.png"
...
<Alert type="informational">
  To create an application you must Sign in. Only signed-in users can create,
...
1. Select your **Application type** (SPA, Web App, Service or Desktop/Mobile)
   ...
   - **Desktop/Mobile** is an application that runs on a desktop computer or mobile device.
     <Alert type="informational">
       Make sure you choose valid Application type. You won't be able to change
       it later.
     </Alert>
...
<Alert type="informational">
  After registering a <strong>Service</strong> or <strong>Web App</strong>{' '}
  application, you will see the success dialog with your{' '}
  <strong>Client Secret</strong>. Make sure you copy and save it. We don't store
  it and you will not be able to see it again.
</Alert>
...
<TutorialSection actions={[
  <Title>My Apps table</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/my-apps-page.png"
     alt="My Apps table"
     className="sample-img-l"
   />,
  <Title>Application details page</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/app-details-page.png"
...
<Alert type="informational">
  To view an application you must Sign in. Only signed-in users can create,
  view, edit or delete applications.
</Alert>
...
<Alert type="informational">
  To edit an application you must Sign in. Only signed-in users can create,
  view, edit or delete applications.
</Alert>
...
<TutorialSection subSection={true} actions={[
  <Title>API associations card</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/api-associations.png"
     alt="API associations card"
     className="sample-img-m"
   />,
   <Title>Add APIs dialog</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/add-apis-dialog.png"
     alt="Add APIs dialog"
     className="sample-img-m"
   />
]}>
...
<TutorialSection subSection={true} actions={[
  <Title>Expanded "Manage your scopes"</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/api-scopes-expanded.png"
...
<TutorialSection subSection={true} actions={[
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/add-owner.png"
     alt="Adding owner"
     className="sample-img-m"
   />
]}>
...
<TutorialSection subSection={true} actions={[
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/remove-owner.png"
...
<TutorialSection subSection={true} actions={[
  <Title>Application details with "Regenerate client secret" button</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/app-details.png"
     alt='Application details with "Regenerate client secret" button'
     className="sample-img-m"
   />,
  <Title>Client Secret regeneration confirmation dialog</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/regenerate-client-secret-confirm-dialog.png"
     alt='Client Secret regeneration confirmation dialog'
     className="sample-img-m"
   />,
  <Title>New Client Secret</Title>,
   <img
     src="/unreal-docs-site/images/tutorials/register-and-modify-application/regenerate-client-secret-success-dialog.png"
...
<Alert type="informational">
  After <strong>Client Secret</strong> regeneration previous secret becomes
  invalid. Make sure to replace old <strong>Client Secret</strong> by new one.
</Alert>
