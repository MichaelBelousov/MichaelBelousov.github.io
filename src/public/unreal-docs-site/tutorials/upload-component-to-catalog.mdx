...
<TutorialSection actions={[<CreateSampleAppButton tooltip="Register a basic SPA App for this tutorial" scopes={['realitydata:read','imodels:read','imodels:modify','library:read', 'library:modify', 'storage:read','storage:modify']} clientName="Upload component to catalog tutorial"/>]}>
