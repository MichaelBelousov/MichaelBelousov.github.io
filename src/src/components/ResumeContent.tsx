      ...
      <section>
        ...
        <div className={"resume-dont-indent"}>
          <h4>
            ...
            &nbsp;
            (May 2018&mdash;May 2024, <small>Resigned, gap until September</small>) <br/>
          </h4>
      ...
      <section className="resume-section-techskills">
        <h2> Technical Skills </h2>
          <div>
            ...
            : <>
              TypeScript/JavaScript, Python, GNU/Linux, React, Node.js, Vue, CSS/Sass,
              <br/>
              Vite, Webpack, esbuild, MongoDb, Postgres, MySQL, AWS Lambda,
              <br/>
